...
# train DAPG
num_demos="15 25 35 15_10 25_10"
for demos in $num_demos; do
    echo /home/kolb/GT/CoRX/hand_dapg/dapg/study_data/${1}/policies/${1}_${demos}_constrained_policy/
    python examples/job_script.py --output /home/kolb/GT/CoRX/hand_dapg/dapg/study_data/${1}/policies/${1}_${demos}_constrained_policy/ --config /home/kolb/GT/CoRX/hand_dapg/dapg/study_data/${1}/configs/dapg_${1}_${demos}.txt
done
